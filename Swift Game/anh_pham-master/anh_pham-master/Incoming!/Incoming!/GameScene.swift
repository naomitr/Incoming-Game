...
class GameScene: SKScene, SKPhysicsContactDelegate {
    ...
    let bulletSound = SKAction.playSoundFileNamed("roblox oof.mp3", waitForCompletion: false)
...
/*
    ...
    func spawnEnemy() {
        ...
        let waitEnemy = SKAction.wait(forDuration: 1)
        let enemySequence = SKAction.sequence([moveEnemy, waitEnemy, deleteEnemy, waitEnemy])
